...
public:
    ...
    {
        m_outfitHead = tibia::getRandomNumber(0, (tibia::Outfits::head.size() / 4) - 1);
        m_outfitBody = tibia::getRandomNumber(0, (tibia::Outfits::body.size() / 4) - 1);
        m_outfitLegs = tibia::getRandomNumber(0, (tibia::Outfits::legs.size() / 4) - 1);
        m_outfitFeet = tibia::getRandomNumber(0, (tibia::Outfits::feet.size() / 4) - 1);
