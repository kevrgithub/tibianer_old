...
namespace tibia
{
    ...
    const int TILE_NUMBER_OFFSET_FROM_PLAYER = 518;
    ...
    namespace Projectiles
    {
        ...
        int spellFire[8] = {1831, 1834, 1836, 1833, 1830, 1832, 1837, 1835};

        int spear[8] = {963, 965, 967, 969, 970, 964, 966, 968};

        int bolt[8] = {972, 974, 976, 978, 979, 973, 975, 977};

        int arrow[8]       = {980, 982, 984, 986, 987, 981, 983, 985};
        int arrowFire[8]   = {1855, 1857, 1859, 1861, 1854, 1856, 1858, 1860};
        int arrowPoison[8] = {1847, 1849, 1851, 1853, 1846, 1848, 1850, 1852};
    }
    ...
    sf::Vector2u getTileCoordsByTileNumber(int tileNumber)
    {
        return sf::Vector2u
        (
            (tileNumber % tibia::MAP_SIZE) * tibia::TILE_SIZE,
            (tileNumber / tibia::MAP_SIZE) * tibia::TILE_SIZE
        );
    }
